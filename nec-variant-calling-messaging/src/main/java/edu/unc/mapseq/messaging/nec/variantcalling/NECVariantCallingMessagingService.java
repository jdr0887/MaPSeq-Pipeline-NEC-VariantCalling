package edu.unc.mapseq.messaging.nec.variantcalling;
...
public class NECVariantCallingMessagingService {

    private final Logger logger = LoggerFactory.getLogger(NECVariantCallingMessagingService.class);
    ...
    public NECVariantCallingMessagingService() {
        super();
    }
    ...
    public void start() throws Exception {
        ...
        NECVariantCallingMessageListener messageListener = new NECVariantCallingMessageListener();
