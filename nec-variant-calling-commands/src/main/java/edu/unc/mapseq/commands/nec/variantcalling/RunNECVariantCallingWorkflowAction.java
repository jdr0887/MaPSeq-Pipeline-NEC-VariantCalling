...
@Command(scope = "nec-variant-calling", name = "run-workflow", description = "Run NEC Variant Calling Workflow")
public class RunNECVariantCallingWorkflowAction extends AbstractAction {
    ...
    public RunNECVariantCallingWorkflowAction() {
        super();
    }
